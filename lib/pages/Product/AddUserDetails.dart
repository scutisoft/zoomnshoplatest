...
class AddUserDetails extends StatefulWidget {
  ...
  AddUserDetails({required this.voidCallback});

  @override
  _AddUserDetailsState createState() => _AddUserDetailsState();
}

class _AddUserDetailsState extends State<AddUserDetails>with TickerProviderStateMixin {
  @override
                          ...
                          Container(
                            ...
                            child:  Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 5,),
                                Text('Add User',style: TextStyle(fontFamily: 'RR',fontSize: 24,color: Colors.black,letterSpacing: 0.1)),
                                Spacer(),
                                GestureDetector(
                                    onTap: () {
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                                ...
                                                child: Row(
                                                  children: [
                                                    Container(
                                                      ...
                                                      clipBehavior: Clip.antiAlias,
                                                      child: Image.asset("assets/images/landingPage/avatar-01.jpg",width: 40,),
                                                    ),
                                                    Container(
                                                      margin: EdgeInsets.only(left: 10),
                                                      child: Column(
                                                        ...
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text('Mr.Sale Rep',style: TextStyle(fontSize: 16,fontFamily: 'RR',color: Color(0xff808080),fontWeight: FontWeight.w600),),
                                                          SizedBox(height: 5,),
                                                          Row(
                                                            children: [
                                                              Text('90923-22264',style: TextStyle(fontSize: 13,fontFamily: 'RM',color: Color(0xffA1A1A1),),),
                                                              SizedBox(width: 10,),
                                                              Text('Delivery',style: TextStyle(fontSize: 13,fontFamily: 'RM',color:tn.primaryColor,),),
                                                            ],
                                                          )
                                                        ],
                                                      ),
                                              ...
                                              Container(
                                                ...
                                                alignment: Alignment.center,
                                                child: Text('Edit',style: TextStyle(fontSize: 14,fontFamily: 'RR',color:tn.primaryColor,),)
                                              ),
                                            ],
                                          ),
                                        );
